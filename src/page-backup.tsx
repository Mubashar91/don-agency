...
import { ArrowRight, BarChart3, Users, Shield, Target, Zap, Database, ChevronDown, Moon, Sun, ArrowUp } from "lucide-react"
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      {/* Navigation */}
      <nav className={`fixed top-0 w-full backdrop-blur-xl border-b z-50 transition-all duration-300 ${
        isScrolled ? 'bg-background/98 border-border shadow-lg' : 'bg-background/95 border-border/60'
      }`}>
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 lg:gap-12">
            ...
            <Button
              ...
              variant="outline"
              className="border-border/70 hover:bg-secondary/80 hover:border-primary/50 text-foreground rounded px-5 h-10 font-medium text-sm transition-all duration-300 hover:scale-105"
            >
              {t.nav.contactUs}
            </Button>
            <Button className="bg-primary hover:bg-primary/85 text-primary-foreground rounded px-6 h-10 font-medium text-sm transition-all duration-300 hover:shadow-lg hover:shadow-primary/30 hover:scale-105">
              {t.nav.getStarted}
            </Button>
          </div>
      ...
      {/* Hero Section */}
      <section className="pt-32 md:pt-44 pb-20 md:pb-28 px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-primary/5 via-transparent to-transparent pointer-events-none" />
        <div className="max-w-7xl mx-auto relative">
          <div className="max-w-5xl animate-fade-in">
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-balance leading-[1.05] mb-8 md:mb-10 tracking-tight animate-slide-up">{t.hero.title}</h1>
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground text-pretty leading-relaxed mb-12 md:mb-16 max-w-4xl font-light animate-slide-up [animation-delay:100ms]">
              {t.hero.subtitle}
            </p>
            <Button className="bg-primary hover:bg-primary/85 text-primary-foreground rounded px-8 md:px-12 h-12 md:h-14 text-sm md:text-base font-semibold transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary/40 animate-slide-up [animation-delay:200ms]">
              {t.hero.cta}
            </Button>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 md:gap-16 mt-20 md:mt-28 pt-20 md:pt-28 border-t border-border/40">
            {t.hero.stats.map((stat, i) => (
              <div key={i} className="group text-center sm:text-left">
                <div className="text-5xl md:text-7xl font-bold text-primary mb-4 transition-all duration-300 group-hover:scale-110 group-hover:text-primary/90">
                  {stat.value}
                </div>
      ...
      <section id="work" className="py-24 px-6 border-t border-border/60">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-card border border-border p-12 rounded-sm hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 group cursor-pointer mb-6 hover:-translate-y-1 hover:bg-card/80">
          ...
          <div className="bg-card border border-border p-12 rounded-sm hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 group cursor-pointer hover:-translate-y-1 hover:bg-card/80">
              <div className="flex items-start justify-between mb-10">
                <div className="flex-1">
                  <div className="text-xs font-bold text-primary mb-4 uppercase tracking-widest">
